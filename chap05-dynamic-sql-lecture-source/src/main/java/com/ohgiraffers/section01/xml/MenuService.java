...
public class MenuService {
    ...
    public void selectMenuByPrice(int price) {
        ...
        /*
        * 동적 쿼리를 쓸 때, 조건문의 값을 비교해야 하는데, 기본자료형으로는 비교가 안된다.
    ...
    public void searchMenuByMainOrCategory(Map<String, Object> criteria) {

        SqlSession sqlSession = getSqlSession();
        mapper = sqlSession.getMapper(DynamicSqlMapper.class);

        List<MenuDTO> menuList = mapper.searchMenuByMainOrCategory(criteria);
