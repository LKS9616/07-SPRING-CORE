...
public class Application {
    ...
    public static void main(String[] args) {
         ...
         * 리플렉션의 주의사항
         *
         * 1. 오버헤드 발생 : 성능 저하를 발생시킬 수 있다. 성능에 민감한 어플리케이션의 경우 사용하지 않는다.
        ...
        // Object 클래스의 getClass() 메소드를 이용하면 class 타입으로 리턴바당 이용 가능하다.
        ...
        try {
            ...
            Class class6 = Class.forName("[Ljava.lang.String;"); // 문자열 배열
