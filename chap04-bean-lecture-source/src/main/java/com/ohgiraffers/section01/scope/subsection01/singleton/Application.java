...
public class Application {
    ...
    *               요청처리가 끝나면 인스턴스를 폐기한다. 웹 어플리케이션 컨텍스트에만 해당된다.
    * session       세션이 종료되면 인스턴스를 폐기한다. 웹어플리케이션 컨텍스트에만 해당한다.
    * globalSession 전역 세션당 하나의 인스턴스를 생성하고 전역 세션이 종료되면 인스턴스를 폐기한다. 포털 어플리케이션 컨텍스트에만 해당된다.
    *
    * */
