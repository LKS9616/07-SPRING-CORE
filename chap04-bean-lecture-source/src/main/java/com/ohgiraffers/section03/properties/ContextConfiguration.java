...
//    private String carpBreadName2;
    ...
    @Bean
    public Product water(@Value("${beverage.water.name:0}") String waterName, @Value("${beverage.water.price:0}") int waterPrice,
                         @Value("${beverage.water.capacity:0}") int waterCapatity) {
        return new Beverage(waterName, waterPrice, waterCapatity);
    }
